...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./KaiNer.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("KN", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S KaiNer -X kill
screen -S KaiNer ./KaiNer
done
]])  
file:close() 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/SOR-KaiNer/Files_KaiNer/main/File_Bot/commands.lua") 
...
local KaiNer_Msg = ''  
if msgs < 100 then 
KaiNer_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
KaiNer_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
KaiNer_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
KaiNer_Msg = 'متفاعل' 
elseif msgs < 1200 then 
KaiNer_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
KaiNer_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
KaiNer_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
KaiNer_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
KaiNer_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
KaiNer_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
KaiNer_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
KaiNer_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
KaiNer_Msg = 'رب التفاعل'  
end 
return KaiNer_Msg 
end
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼┇𝗞𝗔𝗜𝗡𝗘𝗥 𝗖𝗛𝗔𝗡𝗡𝗘𝗟.")  
...
function plugin_KaiNer(msg)
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
plugin = dofile("File_Bot/"..v)
if plugin.KaiNer and msg then
pre_msg = plugin.KaiNer(msg)
end
end
end
...
--------------------------------------------------------------------------------------------------------------
function SourceKaiNer(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,KaiNer_Msg) 
return false  
end 
if text then    
...
os.execute('rm -rf KaiNer.lua')
os.execute('wget https://raw.githubusercontent.com/SOR-KaiNer/KaiNer/main/KaiNer.lua')
...
send(msg.chat_id_, msg.id_,'✯︎¦  عدد الكروبات الان » { '..#group..' }'..KaiNerk..''..KaiNer..'\n✯︎¦  الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
local KaiNer1_Msg = database:get(bot_id.."KaiNer1:Add:Filter:Rp2"..text..msg.chat_id_)   
if KaiNer1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
--------------------------------------------------------------------------------------------------------------
if KaiNer_Msg and not Special(msg) then  
local KaiNer_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if KaiNer_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
database:sadd(bot_id.."KaiNer:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."KaiNer:blocname"..msg.chat_id_)
...
if name_MRAnas then 
names_MRAnas = database:smembers(bot_id.."KaiNer:blocname"..msg.chat_id_) or ""
...
database:set(bot_id.."KaiNer:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."KaiNer:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."KaiNer:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."KaiNer:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."KaiNer:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function Anas_mrAnas_new(mrAnas1,mrAnas2)
if mrAnas2 and mrAnas2.first_name_ then 
if mrAnas2.first_name_:match("(.*)"..database:get(bot_id.."KaiNer:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."KaiNer:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local mrAnas_nnn = database:get(bot_id.."KaiNer:nump"..msg.chat_id_) or 5
local mrAnas_nnn2 = database:get(bot_id.."KaiNer:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(mrAnas_nnn2) == tonumber(mrAnas_nnn) or tonumber(mrAnas_nnn2) > tonumber(mrAnas_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."KaiNer:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "✯︎¦ عزيزي >>["..mrAnas2.username_.."](https://t.me/"..(mrAnas2.username_ or "ccscc2")..")\n✯︎¦ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."KaiNer:teh"..msg.chat_id_).."} بجانب اسمك\n✯︎¦ عدد المحاولات المتبقيه {"..(tonumber(mrAnas_nnn) - tonumber(mrAnas_nnn2)).."}")
end
end
end
end
...
local KaiNerChengName = database:get(bot_id.."KaiNer:Cheng:Name"..data.id_)
if not data.first_name_ then 
if KaiNerChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..KaiNerChengName..']')
database:del(bot_id.."KaiNer:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if KaiNerChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."KaiNer:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local KaiNerChengUserName = database:get(bot_id.."KaiNer:Cheng:UserName"..data.id_)
if not data.username_ then 
if KaiNerChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..KaiNerChengUserName..']')
database:del(bot_id.."KaiNer:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if KaiNerChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."KaiNer:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local KaiNerChengPhoto = database:get(bot_id.."KaiNer:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if KaiNerChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."KaiNer:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if KaiNerChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."KaiNer:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)  
...
[✯︎¦sᴏᴜʀᴄᴇ ғɪʟᴇs ♡](https://t.me/SoKaiNer)
≪━━━━━━━━━━━━━≫
...
if DevAnas(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/SOR-KaiNer/Files_KaiNer/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/SOR-KaiNer/Files_KaiNer/main/File_Bot/"..file)
if res == 200 then
...
local UserName = (b.username_ or "SOR-KaiNer")
...
function Function_KaiNer(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_KaiNer, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_KaiNer, nil)
return false 
end
...
database:set(bot_id.."KaiNer1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."KaiNer1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ✯︎¦ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."KaiNer1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."KaiNer1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."KaiNer1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."KaiNer1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ✯︎¦ تم منع الكلمه مع التحذير")  
database:del(bot_id.."KaiNer1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."KaiNer1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."KaiNer1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."KaiNer1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ✯︎¦ ارسل الكلمه الان")  
database:set(bot_id.."KaiNer1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."KaiNer1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."KaiNer1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."KaiNer1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."KaiNer1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."KaiNer1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."KaiNer1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."KaiNer1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."KaiNer1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ✯︎¦ قائمة المنع \nٴ≪┉ ┉ ┉ ┉ ┉ 𝗞𝗡 ┉  ┉ ┉ ┉ ┉≫ٴ\n"
for k,v in pairs(list) do  
local KaiNer_Msg = database:get(bot_id.."KaiNer1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..KaiNer_Msg.."}\n"    
end  
if #list == 0 then  
...
send(msg.chat_id_, msg.id_,'['..KaiNer_Msg[math.random(#KaiNer_Msg)]..']') 
return false
end
...
------------------------------------------------------------------------
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:KaiNer:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\n ✯︎¦ ارسل الكلمه تريد اضافتها')
database:set(bot_id.."botss:KaiNer:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."botss:KaiNer:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."botss:KaiNer:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:KaiNer:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"✯︎¦ تم حذف الرد من ردود المتعدده")
database:del(bot_id..'botss:KaiNer:Add:Rd:Sudo:Text'..text)
database:del(bot_id..'botss:KaiNer:Add:Rd:Sudo:Text1'..text)
database:del(bot_id..'botss:KaiNer:Add:Rd:Sudo:Text2'..text)
database:del(bot_id.."botss:KaiNer:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."botss:KaiNer:List:Rd:Sudo", text)
return false
end
end
...
local list = database:smembers(bot_id.."botss:KaiNer:List:Rd:Sudo")
for k,v in pairs(list) do  
database:del(bot_id.."botss:KaiNer:Add:Rd:Sudo:Text"..v) 
database:del(bot_id.."botss:KaiNer:Add:Rd:Sudo:Text1"..v) 
database:del(bot_id.."botss:KaiNer:Add:Rd:Sudo:Text2"..v)   
database:del(bot_id.."botss:KaiNer:List:Rd:Sudo")
end
...
database:set(bot_id.."botss:KaiNer:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
...
database:set(bot_id.."botss:KaiNer:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"✯︎¦ ارسل الان الكلمه لحذفها ")
end
if text then  
local test = database:get(bot_id.."botss:KaiNer:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:KaiNer:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:set(bot_id.."botss:KaiNer:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:KaiNer:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:KaiNer:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:KaiNer:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
database:set(bot_id.."botss:KaiNer:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:KaiNer:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:KaiNer:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:KaiNer:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
database:set(bot_id.."botss:KaiNer:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:KaiNer:Add:Rd:Sudo:Text2"..test, text)  
end  
send(msg.chat_id_, msg.id_,"✯︎¦ تم حفظ الرد")
return false  
end  
...
if text then
local Text = database:get(bot_id.."botss:KaiNer:Add:Rd:Sudo:Text"..text)   
local Text1 = database:get(bot_id.."botss:KaiNer:Add:Rd:Sudo:Text1"..text)   
local Text2 = database:get(bot_id.."botss:KaiNer:Add:Rd:Sudo:Text2"..text)   
...
{
{text = '𝗞𝗔𝗜𝗡𝗘𝗥 𝗖𝗛𝗔𝗡𝗡𝗘𝗟', url="t.me/ccscc2"},
},
}
local msg_id = msg.id_/2097152/0.5
...
KaiNer = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(KaiNer)
...
--------------------------------------------------------------------------------------------------------------
SourceKaiNer(data.message_,data)
plugin_KaiNer(data.message_)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ then
...
------------------------------------------------------------------------
local KaiNerAbot = database:get(bot_id.."KaiNer1:Add:Filter:Rp2"..text..result.chat_id_)   
if KaiNerAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ✯︎¦ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ✯︎¦ ["..KaiNerAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local KaiNer1_Msg = database:get(bot_id.."KaiNer1:Add:Filter:Rp2"..text..result.chat_id_)   
if KaiNer1_Msg then    
send(msg.chat_id_, msg.id_," ✯︎¦ "..KaiNer1_Msg)
